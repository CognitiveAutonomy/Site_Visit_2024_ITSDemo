...
class ThrustTutorialMgr:
    ...
    def __init__(self, mode=1, control='joystick', time_limit=60.0):
        ...
        self.background = Background(file_name=IMAGE_PATH + 'Purdue_thrust_tutorial.png', moving_name=IMAGE_PATH + 'road.png',
        ...
        self.mode_font = Font(FONT2, int(FONT_SIZE*2.0), (BOUND_X_MAX/2 - 225, 20))
    ...
    def update(self):
        ...
        self.mode_font.update('Practice Round: Thrust')
    ...
    def render(self):
        ...
        if self.mode == 4:
            ...
            display_surface = pygame.display.set_mode((BOUND_X_MAX, BOUND_Y_MAX))
            font = pygame.font.Font('freesansbold.ttf', 32)
            text = font.render('End of Tutorial: %.2f sec' % self.time_limit, True,
                               WHITE, BLACK)
            textrect = text.get_rect()
            textrect.center = (BOUND_X_MAX // 2, BOUND_Y_MAX // 2)
            display_surface.fill(BLACK)
